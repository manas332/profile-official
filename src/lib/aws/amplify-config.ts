...
if (!process.env.NEXT_PUBLIC_APP_AWS_COGNITO_USER_POOL_ID) {
  console.warn("NEXT_PUBLIC_APP_AWS_COGNITO_USER_POOL_ID is not set");
}

if (!process.env.NEXT_PUBLIC_APP_AWS_COGNITO_CLIENT_ID) {
